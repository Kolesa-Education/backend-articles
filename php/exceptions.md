...
ВАЖНОЕ ПРИМЕЧАНИЕ: Здесь я пишу на псевдокоде, на выдуманном Си-подобном языке. Так как в Go нет исключений[^go-panic], а PHP я не знаю хорошо, то раскрываю таким образом механизм общий, для большинства языков
